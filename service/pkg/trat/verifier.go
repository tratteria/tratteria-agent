...
func NewSignatureVerifier(audience string, issuer string) *SignatureVerifier {
...
func (v *SignatureVerifier) ParseAndVerify(tokenStr string, jwksJson string) (*TxnToken, error) {
...
func (v *SignatureVerifier) ParseWithoutVerification(tokenStr string) (*TxnToken, error) {
